    ...
    public enum MotorPolarity {
        ...
        internal string to_string () {
            ...
            case MotorPolarity.NORMAL:
                return "normal";
            case MotorPolarity.INVERTED:
                return "inverted";
            default:
                critical ("Unknown MotorPolarity");
                return "error";
            }
        }
         ...
         */
        internal static MotorPolarity from_string (string polarity) {
            switch (polarity) {
            case "normal":
                return MotorPolarity.NORMAL;
            case "inverted":
                return MotorPolarity.INVERTED;
            default:
                critical ("Unknown MotorPolarity");
                return (MotorPolarity)(-1);
            }
        }
    }
}